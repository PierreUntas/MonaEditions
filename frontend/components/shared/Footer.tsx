        ...
        <footer className="bg-[#f5f3ef] border-t border-[#d6d0c8] mt-auto">
            <div className="max-w-6xl mx-auto px-6 py-16">
                ...
                <div className="flex flex-wrap items-center gap-x-6 gap-y-2 py-6 border-b border-[#d6d0c8]">
                    <a href="mailto:contact@monaeditions.art" className="text-[12px] font-light text-[#78716c] hover:text-[#1c1917] transition-colors no-underline">contact@monaeditions.art</a>
